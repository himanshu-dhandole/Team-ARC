...
const Testimonials = () => {
  ...
  const testimonials: TestimonialProps[] = [
    {
      quote: "TEAM ARC delivered our Web3 protocol on time with production-ready quality. Their blockchain expertise and attention to detail made all the difference.",
      author: "SARAH W.",
      gradient: "bg-gradient-to-br from-blue-400 via-blue-300 to-yellow-200"
    },
    {
      quote: "Working with TEAM ARC was seamless. They built our backend infrastructure with Spring Boot and handled complex microservices architecture flawlessly.",
      author: "ANDREW P.",
      gradient: "bg-gradient-to-br from-green-500 via-green-400 to-lime-300"
    },
    {
      quote: "The team shipped our full-stack product faster than expected. Their GenAI integrations and modern frontend work exceeded our expectations.",
      author: "SONIA H.",
      gradient: "bg-gradient-to-br from-cyan-400 via-teal-300 to-emerald-200"
    },
    {
      quote: "TEAM ARC transformed our idea into a scalable platform. Their expertise in both Web2 and Web3 technologies gave us the best of both worlds.",
      author: "MICHAEL K.",
      gradient: "bg-gradient-to-br from-purple-400 via-pink-300 to-rose-200"
    },
    {
      quote: "From smart contracts to UI/UX, the team handled everything with professionalism. Our DeFi platform launched without a single issue.",
      author: "JENNIFER L.",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-[52px] sm:text-[68px] font-serif tracking-tight text-gray-900 leading-tight mb-2">
            <span className="italic font-light text-gray-600">Read</span> what people say
          </h2>
        </div>
